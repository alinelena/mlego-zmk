...
int zmk_widget_status_init(struct zmk_widget_status *widget, lv_obj_t *parent) {
...
#endif
  lv_canvas_set_buffer(top, widget->cbuf1, CONFIG_DISP_CANVAS,
                       CONFIG_DISP_CANVAS, CANVAS_COLOR_FORMAT);
...
#endif
  lv_canvas_set_buffer(middle, widget->cbuf2, CONFIG_DISP_CANVAS,
                       CONFIG_DISP_CANVAS, CANVAS_COLOR_FORMAT);
...
#endif
  lv_canvas_set_buffer(bottom, widget->cbuf3, CONFIG_DISP_CANVAS,
                       CONFIG_DISP_CANVAS, CANVAS_COLOR_FORMAT);
  ...
  lv_canvas_set_buffer(picture, widget->cbuf4, elep.header.h, elep.header.w,
                       CANVAS_COLOR_FORMAT);
#if CONFIG_DISP_ROTATE == 900
  ...
  lv_canvas_set_buffer(picture, widget->cbuf4, elep.header.w, elep.header.h,
                       CANVAS_COLOR_FORMAT);
